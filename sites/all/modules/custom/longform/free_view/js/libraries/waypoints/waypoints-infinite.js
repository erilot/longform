  ...
  (function(root, factory) {
    ...
    return $.waypoints('extendFn', 'infinite', function(options) {
      ...
      opts.handler = function(direction) {
        ...
        fetchQuantity = localStorage.getItem('fetchQuantity');
        if (fetchQuantity == 0 && (direction === 'down' || direction === 'right')) {
          fetchQuantity = 1;
        }
        else if (fetchQuantity == 0 && (direction === 'up' || direction === 'left')) {
          fetchQuantity = -1;
        }
        
        href = $(opts.more).attr('href') + '?quantity=' + fetchQuantity;
        if (direction === 'down' || direction === 'right') {
          $this = $(this);
          opts.onBeforePageLoad(this);
